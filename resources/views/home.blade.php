                            ...
                            <div class="col-lg-6 tm-col-home mb-4">
                                <div class="tm-text-container">
                                    <div class="tm-icon-container mb-5 mr-0 ml-auto">
                                        <img src="img/homeimage.jpg" width="550" height="200">
                                    </div>                                
                                    <p>
                    ...
                    <section id="about" class="tm-section">
                        ...
                        <div class="row tm-row-about">
                            <div class="tm-col-about tm-col-about-l">
                                <p class="mb-4">
                                    Owning a professional distribution network, stretching across the country, the real estate services segment provided by Thien Hung is a comprehensive ecosystem of consulting, buying and selling, brokerage, valuation, management. management - real estate exploitation, financial services...</p>
                                <p class="mb-4">
                                    In particular, Thien Hung pioneered in integrating all real estate service activities on one technology platform; provide complete and transparent project information; making the buying and selling process quick and easy.
                                </p>
                            </div>
